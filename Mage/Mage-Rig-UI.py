...
# The bone roll for the hands is misaligned, I'm sorry. Blame Hopoo.
# Also the weight painting for the cloth is subpar so there are no tweak bones for it.

import bpy

armatureName = "MageArmature"
rig_id = "MAGE_RIG_ID"

class MAGE_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Mage_RigUI"
...
################################ Visibility ################################ 
class MAGE_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "MAGE_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Cloth
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Front Cloth"], 'is_visible', toggle=True, text="FRONT CLOTH")
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Back Cloth"], 'is_visible', toggle=True, text="BACK CLOTH")
        row = row.split(align=True)
        row.prop(boneCollections["CTRL-Back Cloth Tweak"], 'is_visible', toggle=True, text="BACK CLOTH TWEAK")

################################ Snapping ################################
class MAGE_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "mage.snap_master"
    bl_label = ""
...
class MAGE_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "MAGE_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("mage.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class MAGE_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "MAGE_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_RigUI.bl_idname
...
class MAGE_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "MAGE_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['MageArmature'].pose.bones['PROPERTIES']
...
class MAGE_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "MAGE_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_Properties.bl_idname
...
class MAGE_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "MAGE_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_Properties.bl_idname
...
class MAGE_PT_ClothProperties(bpy.types.Panel):
    bl_label = "Cloth Properties"
    bl_idname = "MAGE_PT_ClothProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MAGE_PT_Properties.bl_idname
...
panels = (MAGE_PT_RigUI,
          MAGE_PT_Visibility, 
          MAGE_PT_Snap_Utilities, 
          MAGE_PT_Properties,
          MAGE_PT_HeadProperties,
          MAGE_PT_ArmProperties,
          MAGE_PT_LegProperties,
          MAGE_PT_ClothProperties,
          MAGE_OP_SNAP_MASTER
          )
