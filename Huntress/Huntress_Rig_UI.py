...
# The "Bow Parent" property controls which bone the
# bow is parented to. This affects the parent bone of the bow controller and not
# the bow controller itself, so reset the CTRL bone to its base position if it
# looks out of place.
...
#  1 - Base
#  2 - Chest
#  3 - Hand.L FK - Also snaps the shotgun to the FK hand

import bpy

armatureName = "HuntressArmature"
rig_id = "HUNTRESS_RIG_ID"

class HUNTRESS_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Huntress_RigUI"
...
################################ Visibility ################################ 
class HUNTRESS_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "HUNTRESS_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Scarf"], 'is_visible', toggle=True, text="SCARF")

        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Bow"], 'is_visible', toggle=True, text="BOW")

################################ Snapping ################################
class HUNTRESS_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "huntress.snap_master"
    bl_label = ""
...
class HUNTRESS_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "HUNTRESS_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("huntress.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class HUNTRESS_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "HUNTRESS_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_RigUI.bl_idname
...
class HUNTRESS_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "HUNTRESS_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['HuntressArmature'].pose.bones['PROPERTIES']
...
class HUNTRESS_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "HUNTRESS_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Hand.L IK Hold Bow")
        row.split(align= True)
        row.prop(bone, '["Hand.L Hold Bow"]', text = "", slider=True)
        ...
        row = column.row(align=True)
        row.label(text = "Hand.R IK Hold Bow")
        row.split(align= True)
        row.prop(bone, '["Hand.R Hold Bow"]', text = "", slider=True)


class HUNTRESS_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "HUNTRESS_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_Properties.bl_idname
...
class HUNTRESS_PT_BowProperties(bpy.types.Panel):
    bl_label = "Bow Properties"
    bl_idname = "HUNTRESS_PT_BowProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Bow Parent")
        row.split(align= True)
        row.prop(bone, '["Bow Parent"]', text = "", slider=False)

class HUNTRESS_PT_ScarfProperties(bpy.types.Panel):
    bl_label = "Scarf Properties"
    bl_idname = "HUNTRESS_PT_ScarfProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = HUNTRESS_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Scarf Follow")
        row.split(align= True)
        row.prop(bone, '["Scarf Follow"]', text = "", slider=True)

        row = column.row(align=True)
        row.label(text = "Scarf Stretch")
        row.split(align= True)
        row.prop(bone, '["Scarf Stretch"]', text = "", slider=True)

panels = (HUNTRESS_PT_RigUI,
          HUNTRESS_PT_Visibility, 
          HUNTRESS_PT_Snap_Utilities, 
          HUNTRESS_PT_Properties,
          HUNTRESS_PT_HeadProperties,
          HUNTRESS_PT_ArmProperties,
          HUNTRESS_PT_LegProperties,
          HUNTRESS_PT_ScarfProperties,
          HUNTRESS_PT_BowProperties,
          HUNTRESS_OP_SNAP_MASTER
          )
