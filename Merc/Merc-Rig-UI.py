...
armatureName = "MercArmature"
rig_id = "MERC_RIG_ID"

class MERC_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Merc_RigUI"
...
################################ Visibility ################################ 
class MERC_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "MERC_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Sword"], 'is_visible', toggle=True, text="SWORD")

################################ Snapping ################################
class MERC_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "merc.snap_master"
    bl_label = ""
...
class MERC_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "MERC_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("merc.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class MERC_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "MERC_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_RigUI.bl_idname
...
class MERC_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "MERC_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['MercArmature'].pose.bones['PROPERTIES']
...
class MERC_PT_SwordProperties(bpy.types.Panel):
    bl_label = "Sword Properties"
    bl_idname = "MERC_PT_SwordProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Sword Parent")
        row.split(align= True)
        row.prop(bone, '["Sword Parent"]', text = "", slider=False)

class MERC_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "MERC_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Hand.L IK Hold Sword")
        row.split(align= True)
        row.prop(bone, '["Hand.L IK Hold Sword"]', text = "", slider=True)
        ...
        row = column.row(align=True)
        row.label(text = "Hand.R IK Hold Sword")
        row.split(align= True)
        row.prop(bone, '["Hand.R IK Hold Sword"]', text = "", slider=True)


class MERC_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "MERC_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = MERC_PT_Properties.bl_idname
...
panels = (MERC_PT_RigUI,
          MERC_PT_Visibility, 
          MERC_PT_Snap_Utilities, 
          MERC_PT_Properties,
          MERC_PT_HeadProperties,
          MERC_PT_ArmProperties,
          MERC_PT_LegProperties,
          MERC_PT_SwordProperties,
          MERC_OP_SNAP_MASTER
          )
