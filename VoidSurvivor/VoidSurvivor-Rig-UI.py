...
armatureName = "VoidSurvivorArmature"
rig_id = "VOIDSURVIVOR_RIG_ID"

class VOIDSURVIVOR_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_VoidSurvivor_RigUI"
...
################################ Visibility ################################ 
class VOIDSURVIVOR_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "VOIDSURVIVOR_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_RigUI.bl_idname
...
################################ Snapping ################################
class VOIDSURVIVOR_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "voidsurvivor.snap_master"
    bl_label = ""
...
class VOIDSURVIVOR_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "VOIDSURVIVOR_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("voidsurvivor.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class VOIDSURVIVOR_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "VOIDSURVIVOR_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_RigUI.bl_idname
...
class VOIDSURVIVOR_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "VOIDSURVIVOR_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['VoidSurvivorArmature'].pose.bones['PROPERTIES']
...
class VOIDSURVIVOR_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "VOIDSURVIVOR_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_Properties.bl_idname
...
class VOIDSURVIVOR_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "VOIDSURVIVOR_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = VOIDSURVIVOR_PT_Properties.bl_idname
...
panels = (VOIDSURVIVOR_PT_RigUI,
          VOIDSURVIVOR_PT_Visibility, 
          VOIDSURVIVOR_PT_Snap_Utilities, 
          VOIDSURVIVOR_PT_Properties,
          VOIDSURVIVOR_PT_HeadProperties,
          VOIDSURVIVOR_PT_ArmProperties,
          VOIDSURVIVOR_PT_LegProperties,
          VOIDSURVIVOR_OP_SNAP_MASTER
          )
