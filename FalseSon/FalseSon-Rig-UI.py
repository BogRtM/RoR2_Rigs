...
armatureName = "FSArmature"
rig_id = "FALSESON_RIG_ID"

class FALSESON_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_FalseSon_RigUI"
...
################################ Visibility ################################ 
class FALSESON_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "FALSESON_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Club"], 'is_visible', toggle=True, text="CLUB")
...
################################ Snapping ################################
class FALSESON_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "falseson.snap_master"
    bl_label = ""
...
class FALSESON_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "FALSESON_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("falseson.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class FALSESON_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "FALSESON_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_RigUI.bl_idname
...
class FALSESON_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head/Torso Properties"
    bl_idname = "FALSESON_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['FSArmature'].pose.bones['PROPERTIES']
        
        row = column.row(align=True)
        row.label(text = "Torso Follow")
        row.split(align= True)
        row.prop(bone, '["Torso Follow"]', text = "", slider=True)
...
class FALSESON_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "FALSESON_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Hand.R IK Hold Club")
        row.split(align= True)
        row.prop(bone, '["Hand.R IK Hold Club"]', text = "", slider=True)


class FALSESON_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "FALSESON_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_Properties.bl_idname
...
class FALSESON_PT_ClothProperties(bpy.types.Panel):
    bl_label = "Cloth Properties"
    bl_idname = "FALSESON_PT_ClothProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = FALSESON_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Cloth Top Follow")
        row.split(align= True)
        row.prop(bone, '["Cloth Top Follow"]', text = "", slider=True)
        
        row = column.row(align=True)
        row.label(text = "Cloth Bottom Follow")
        row.split(align= True)
        row.prop(bone, '["Cloth Bottom Follow"]', text = "", slider=True)

        row = column.row(align=True)
        row.label(text = "Cloth Stretch")
        row.split(align= True)
        row.prop(bone, '["Cloth Stretch"]', text = "", slider=True)

panels = (FALSESON_PT_RigUI,
          FALSESON_PT_Visibility, 
          FALSESON_PT_Snap_Utilities, 
          FALSESON_PT_Properties,
          FALSESON_PT_HeadProperties,
          FALSESON_PT_ArmProperties,
          FALSESON_PT_LegProperties,
          FALSESON_PT_ClothProperties,
          FALSESON_OP_SNAP_MASTER
          )
