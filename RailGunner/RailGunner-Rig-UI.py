...
# The IK > FK snapping is *really* bad on the arms. I'm sorry.

# The "Gun Parent" property controls which bone the gun is parented to. 
# This affects the parent bone of the gun controller and not
...
# The Hand.L Hold Gun property changes the hand's position on the gun. 1 makes the hand
# hold the gun in the SMG position, 2 makes it hold the gun in sniper position.

import bpy

armatureName = "RailGunnerArmature"
rig_id = "RAILGUNNER_RIG_ID"

class RAILGUNNER_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_RailGunner_RigUI"
...
################################ Visibility ################################ 
class RAILGUNNER_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "RAILGUNNER_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Gun
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Gun"], 'is_visible', toggle=True, text="GUN")
        row = row.split(align=True)
        row.prop(boneCollections["CTRL-Gun Misc"], 'is_visible', toggle=True, text="GUN MISC")

        column.separator(factor = 1.5, type='LINE')

        #Coat
        row = column.row(align=True)
        row.prop(boneCollections["CTRL-Backpack"], 'is_visible', toggle=True, text="BACKPACK")

################################ Snapping ################################
class RAILGUNNER_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "railgunner.snap_master"
    bl_label = ""
...
class RAILGUNNER_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "RAILGUNNER_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("railgunner.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class RAILGUNNER_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "RAILGUNNER_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_RigUI.bl_idname
...
class RAILGUNNER_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "RAILGUNNER_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['RailGunnerArmature'].pose.bones['PROPERTIES']
...
class RAILGUNNER_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "RAILGUNNER_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Hand.L Hold Gun")
        row.split(align= True)
        row.prop(bone, '["Hand.L Hold Gun"]', text = "", slider=False)
        ...
        row = column.row(align=True)
        row.label(text = "Hand.R Hold Gun")
        row.split(align= True)
        row.prop(bone, '["Hand.R Hold Gun"]', text = "", slider=True)


class RAILGUNNER_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "RAILGUNNER_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_Properties.bl_idname
...
class RAILGUNNER_PT_GunProperties(bpy.types.Panel):
    bl_label = "Gun Properties"
    bl_idname = "RAILGUNNER_PT_GunProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = RAILGUNNER_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Gun Parent")
        row.split(align= True)
        row.prop(bone, '["Gun Parent"]', text = "", slider=False)

        row = column.row(align=True)
        row.label(text = "Gun Target")
        row.split(align= True)
        row.prop(bone, '["Gun Target"]', text = "", slider=True)

panels = (RAILGUNNER_PT_RigUI,
          RAILGUNNER_PT_Visibility, 
          RAILGUNNER_PT_Snap_Utilities, 
          RAILGUNNER_PT_Properties,
          RAILGUNNER_PT_HeadProperties,
          RAILGUNNER_PT_ArmProperties,
          RAILGUNNER_PT_LegProperties,
          RAILGUNNER_PT_GunProperties,
          RAILGUNNER_OP_SNAP_MASTER
          )
