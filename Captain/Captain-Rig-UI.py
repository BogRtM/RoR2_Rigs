...
armatureName = "CaptainArmature"
rig_id = "CAPTAIN_RIG_ID"

class CAPTAIN_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Captain_RigUI"
...
################################ Visibility ################################ 
class CAPTAIN_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "CAPTAIN_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_RigUI.bl_idname
...
################################ Snapping ################################
class CAPTAIN_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "captain.snap_master"
    bl_label = ""
...
class CAPTAIN_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "CAPTAIN_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("captain.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class CAPTAIN_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "CAPTAIN_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_RigUI.bl_idname
...
class CAPTAIN_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "CAPTAIN_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['CaptainArmature'].pose.bones['PROPERTIES']
...
class CAPTAIN_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "CAPTAIN_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_Properties.bl_idname
...
class CAPTAIN_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "CAPTAIN_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CAPTAIN_PT_Properties.bl_idname
...
panels = (CAPTAIN_PT_RigUI,
          CAPTAIN_PT_Visibility, 
          CAPTAIN_PT_Snap_Utilities, 
          CAPTAIN_PT_Properties,
          CAPTAIN_PT_HeadProperties,
          CAPTAIN_PT_ArmProperties,
          CAPTAIN_PT_LegProperties,
          CAPTAIN_OP_SNAP_MASTER
          )
