...
armatureName = "SeekerArmature"
rig_id = "SEEKER_RIG_ID"

class SEEKER_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Seeker_RigUI"
...
################################ Visibility ################################ 
class SEEKER_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "SEEKER_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_RigUI.bl_idname
...
################################ Snapping ################################
class SEEKER_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "seeker.snap_master"
    bl_label = ""
...
class SEEKER_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "SEEKER_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("seeker.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class SEEKER_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "SEEKER_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_RigUI.bl_idname
...
class SEEKER_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "SEEKER_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['SeekerArmature'].pose.bones['PROPERTIES']
...
class SEEKER_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "SEEKER_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_Properties.bl_idname
...
class SEEKER_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "SEEKER_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_Properties.bl_idname
...
class SEEKER_PT_ClothProperties(bpy.types.Panel):
    bl_label = "Cloth Properties"
    bl_idname = "SEEKER_PT_ClothProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = SEEKER_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Tassle Follow")
        row.split(align= True)
        row.prop(bone, '["Tassle Follow"]', text = "", slider=True)
        
        row = column.row(align=True)
        row.label(text = "Cloth Follow")
        row.split(align= True)
        row.prop(bone, '["Cloth Follow"]', text = "", slider=True)
...
panels = (SEEKER_PT_RigUI,
          SEEKER_PT_Visibility, 
          SEEKER_PT_Snap_Utilities, 
          SEEKER_PT_Properties,
          SEEKER_PT_HeadProperties,
          SEEKER_PT_ArmProperties,
          SEEKER_PT_LegProperties,
          SEEKER_PT_ClothProperties,
          SEEKER_OP_SNAP_MASTER
          )
