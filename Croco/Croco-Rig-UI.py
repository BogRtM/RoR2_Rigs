...
armatureName = "CrocoArmature"
rig_id = "CROCO_RIG_ID"

class CROCO_PT_RigUI(bpy.types.Panel):
    bl_label = "Rig UI"
    bl_idname = "VIEW3D_PT_Croco_RigUI"
...
################################ Visibility ################################ 
class CROCO_PT_Visibility(bpy.types.Panel):
    bl_label = "Bone Visibility"
    bl_idname = "CROCO_PT_Visibility"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_RigUI.bl_idname
...
################################ Snapping ################################
class CROCO_OP_SNAP_MASTER(bpy.types.Operator):
    bl_idname = "croco.snap_master"
    bl_label = ""
...
class CROCO_PT_Snap_Utilities(bpy.types.Panel):
    bl_label = "Snap Utilities"
    bl_idname = "CROCO_PT_Snap Utilities"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_RigUI.bl_idname
    ...
    def draw(self, context):
        ...
        #Arms
        row = column.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="ARM.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="ARM.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="ARM.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="ARM.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Arm'
        op.side = 'R'
        op.snapTo = 'IK-FK'
        ...
        #Legs
        row = column.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="LEG.L FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'FK-IK'
        row = row.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="LEG.R FK > IK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'FK-IK'

        row = column.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="LEG.L IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'L'
        op.snapTo = 'IK-FK'
        row = row.row(align=True)
        op = row.operator("croco.snap_master", emboss=True, text="LEG.R IK > FK", icon = "SNAP_ON")
        op.limb = 'Leg'
        op.side = 'R'
        op.snapTo = 'IK-FK'

################################ Properties ################################ 
class CROCO_PT_Properties(bpy.types.Panel):
    bl_label = "Properties"
    bl_idname = "CROCO_PT_Properties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_RigUI.bl_idname
...
class CROCO_PT_HeadProperties(bpy.types.Panel):
    bl_label = "Head Properties"
    bl_idname = "CROCO_PT_HeadProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_Properties.bl_idname
    bl_options = {'DEFAULT_CLOSED'}
    ...
    def draw(self, context):
        ...
        bone = bpy.data.objects['CrocoArmature'].pose.bones['PROPERTIES']
        ...
        row = column.row(align=True)
        row.label(text = "Tongue Follow")
        row.split(align= True)
        row.prop(bone, '["Tongue Follow"]', text = "", slider=True)

class CROCO_PT_ArmProperties(bpy.types.Panel):
    bl_label = "Arm Properties"
    bl_idname = "CROCO_PT_ArmProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Chain.L Follow")
        row.split(align= True)
        row.prop(bone, '["Chain.L Follow"]', text = "", slider=True)
        ...
        row = column.row(align=True)
        row.label(text = "Chain.R Follow")
        row.split(align= True)
        row.prop(bone, '["Chain.R Follow"]', text = "", slider=True)


class CROCO_PT_LegProperties(bpy.types.Panel):
    bl_label = "Leg Properties"
    bl_idname = "CROCO_PT_LegProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_Properties.bl_idname
...
class CROCO_PT_TailProperties(bpy.types.Panel):
    bl_label = "Tail Properties"
    bl_idname = "CROCO_PT_TailProperties"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "Item"
    bl_parent_id = CROCO_PT_Properties.bl_idname
    ...
    def draw(self, context):
        ...
        row = column.row(align=True)
        row.label(text = "Tail Follow")
        row.split(align= True)
        row.prop(bone, '["Tail Follow"]', text = "", slider=True)

panels = (CROCO_PT_RigUI,
          CROCO_PT_Visibility, 
          #CROCO_PT_Snap_Utilities, 
          CROCO_PT_Properties,
          CROCO_PT_HeadProperties,
          CROCO_PT_ArmProperties,
          CROCO_PT_LegProperties,
          CROCO_PT_TailProperties,
          #CROCO_OP_SNAP_MASTER
          )
